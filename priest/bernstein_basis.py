...
def bernstein10(t, t_min=0, t_max=1):
    '''
    Bernstein basis polynomials of order 10 and their derivatives.
    ...
    Output
    P: Polynomial values
    Pdot: First derivative
    Pddot: Second dericative
    '''
    ...
    Pdot = np.vstack((P0dot, P1dot, P2dot, P3dot, P4dot, P5dot, P6dot, P7dot, P8dot, P9dot, P10dot ))/delta_t
    Pddot = np.vstack((P0ddot, P1ddot, P2ddot, P3ddot, P4ddot, P5ddot, P6ddot, P7ddot, P8ddot, P9ddot, P10ddot ))/(delta_t**2)

    return jnp.asarray(P), jnp.asarray(Pdot), jnp.asarray(Pddot)
